package com.weberpackage.scribly.common.presentation.state
...
fun rememberEventDialogState(
    ...
    return rememberSaveable(saver = EventDialogState.Saver(state)) {
        EventDialogState(
            state, DialogEvent(
                title = UiText(com.weberpackage.scribly.R.string.error),
                message = UiText(com.weberpackage.scribly.R.string.error),
                positiveAction = DialogAction(
                    buttonText = UiText(com.weberpackage.scribly.R.string.error),
                    action = {}
                )
            )
        )
